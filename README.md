...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-01 10:37`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bef1bdbc-8f6c-45c0-9abe-248900887c6d.git
$ cd bef1bdbc-8f6c-45c0-9abe-248900887c6d
```
